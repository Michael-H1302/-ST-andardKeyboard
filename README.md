A custom keyboard design made with KiCad. The Design uses a STM32 Blue Pill Microcontroller featuring red led backlight that can be controlled in three groups (two rows per group). 
